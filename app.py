...
st.markdown("""
    ...
    .val { font-size: 2.5rem; font-weight: 900; margin: 5px 0; }
...
if not df.empty:
    ...
    # --- Tab 2: Lifetime Stats (Compressed to 1 Page) ---
    with tab2:
        l = df.iloc[-1]
    ...
    with tab3:
        ...
        fig = go.Figure()
        fig.add_trace(go.Scatter(x=dates, y=weights, mode='lines+markers', line=dict(color='#ffffff', width=4)))
