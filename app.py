...
def load_data():
    try:
        ...
        # Use first row as header if you want, or just slice. 
        # Using [1:] ensures we get rows, not headers.
...
if not df.empty:
    ...
    with tab3:
        ...
        # Ensure we are using Column A (Date - index 0) and Column D (Weight - index 3)
        dates = df.iloc[:, 0]
